...
$sql1    ="SELECT a.election_id, a.election_name, a.status, a.date_started, a.date_end, b.description
            ...
            WHERE a.election_name='FCE' AND a.election_id='$electionID'";
...
<body>
    <p class="p_text mb-n4">Faculty ID: <?php echo $username_id; ?></p>
    ...
    <!-- <table class="border_c" width="560" border="0" cellpadding="2" cellspacing="0">
        ...
        <tbody>
            ...
            <?php
                ...
                //                       WHERE c.election_id = '$electionID' and d.election_type='FCE') b

...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-sm tableDark" id="dttables_user2">
        <thead class="nowrap">
            <tr class="text-center th-fs"> 
        ...
        <tbody class="">
            ...
            $sql_get = "SELECT a.rec_id, a.username_id, a.first_name, a.middle_name, a.last_name, a.email, a.dept_id, a.year,
                        ...
                        WHERE a.access_rights IN ('std_admin','std_voter') and a.username_id NOT IN (SELECT student_id FROM tbl_candidates)

            ...
            <div class="row">
                ...
                <div class="col-sm-4 mb-1">
                    ...
                    <div class="input-group input-group-sm">
                        <input readonly id="student_id" type="text" class="form-control form-control-sm"  placeholder="Student No." required>
                ...
                <div class="col-sm-6 mb-1">
                    ...
                    <select id="position" class="form-select form-select-sm" required>
                ...
                <div class="col-sm-6 mb-1">
                    ...
                    <select id="election_id" class="form-select form-select-sm" required>
                       <option value="" selected disabled>Select Election</option>
                        <?php
                          

                            $get = "SELECT a.election_id, a.election_name, b.description
                                    FROM tbl_election a
                                    LEFT JOIN tbl_election_type b
                                    ON a.election_name = b.election_type
                                    WHERE status = 'N'  AND election_name = 'USC'";
                            $res = mysqli_query($db, $get);
                        ...
                        ?>
                        <option value="<?php echo $row['election_id']; ?>" <?php echo $xslctd; ?>> <?php echo $row['election_id'].' - '.$row['description']; ?> </option> 
                     <?php  } ?>   
                    </select>
                ...
                <div class="col-sm-12 mb-1">
                    ...
                    <textarea id="platform" class="form-control" rows="3" required></textarea>
                    <div class="invalid-feedback"> Please enter Last Name</div>
                </div>

                <div class="col-sm-12 mb-1">
                    <label for="first_name" class="form-label-sm fw-bold">Upload Image</label>
                    <input class="form-control form-control-sm upload_img" type="file" id="upload_img" name="upload_img" value="">
                </div>

    ...
    <div id="layoutSidenav_content">
        ...
        <main> 
            <div class="container">  
                ...
                <button id="btnAddUser" type="button" class="btn btn-orange my-5" data-bs-toggle="modal" data-bs-target="#viewUserModal"><span class="p-3"><i class="fa fa-plus">&nbsp;</i>Add Faculty Admin</span></button>
            </div>
        </main>     
...
<script> 
    ...
    $(document).on("click", ".untag", function() {
       ...
       var active          = myarr_atc[2];
        ...
        var title_label = "Make Faculty Voter and Untag as Admin. ";

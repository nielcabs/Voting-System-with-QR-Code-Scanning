                ...
                <div class="form-floating col-lg-12">
                    <select id="election_id" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                            ...
                            <?php
                                ...
                                ?>
                                <option value="<?php echo $row['election_id'].'|'. $row['election_type']; ?>" <?php echo $xslctd; ?>> <?php echo $election_title; ?></option> 
                            <?php  } ?>   
                    </select>
...
<script> 
    ...
    //                 alert(response)
    //                 if($.trim(response)=="Printed Vote Result"){

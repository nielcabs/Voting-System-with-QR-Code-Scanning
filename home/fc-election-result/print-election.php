...
$dateOfElection       = strtoupper(date('F d, Y',strtotime($date_started)));
  ...
  $elec_description1     = $dateOfElection.' '.strtoupper($elec_description).' ELECTIONS';
  $canvass_label        = strtoupper($elec_description)." CANVASS REPORT";
...
$pdf->Cell(30 ,12,"","",0,"C");
$pdf->Cell(130 ,12,"$elec_description1","",0,"C");
$pdf->Cell(30 ,12,"","",0,"C");
$pdf->Ln(5);
$pdf->SetFont("Arial","",11);
$pdf->Cell(30 ,12,"","",0,"C");
...
$pdf->Cell(20 ,7,"Faculty ID No.","RLTB",0,"C");

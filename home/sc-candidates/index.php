    ...
    <div id="layoutSidenav_content">
        <main> 
            <div class="container">  
                ...
                <h4 class="mt-5 mb-4">
                    Register Localized Student Council
                </h4>
...
<script> 
    ...
    $(document).on("click", "#btnSave", function(event) {
            ...
            if(election_id == null) {
                ...
                var myarr_id        = election_id.split("-");
                var elct            = myarr_id[0];
                var deptid          = myarr_id[1];
            }
            ...
            } else if (department != deptid) {
                Swal.fire('Department and Local Election Department doesn`t match, Please check.','', 'error')
                event.stopPropagation();
            } else {  

...
<?php
    ...
    while($row    = mysqli_fetch_assoc($result)) {
        ...
        if($position =="PD" || $position =="GV") {
            $candidate_a[] = array (
                'candidate_name'  => $candidate_name,
                'vote_count'      => $vote_count,
            );
            $position_name_a = $post_name;
        } else if($position =="VP" || $position =="VG"){
        ...
        }  else if($position =="SR" || $position =="BMR"){
        ...
        }  else if($position =="SF" || $position =="BMF"){
        ...
        }  else if($position =="SA" || $position =="BMA"){
        ...
        }  else if($position =="SPI" || $position =="BBA"){
        ...
        }  else if($position =="SBA" || $position =="BMSA"){
        ...
        }  else if($position =="SSA" || $position =="BMSS"){
        ...
        } else if($position =="SSR" || $position =="BMPI"){

            $candidate_i[] = array (
                'candidate_name'  => $candidate_name,
                'vote_count'      => $vote_count
            );
            $position_name_i = $post_name;
        } else if($position =="SGD" || $position =="BMGD"){

            $candidate_j[] = array (
                'candidate_name'  => $candidate_name,
                'vote_count'      => $vote_count
            );
            $position_name_j = $post_name;
        }
    }
        ...
        $json_candidate_i = json_encode($candidate_i);
        $json_candidate_j = json_encode($candidate_j);
?>
...
<script>
    ...
    function position_i(){                                  
        ...
        am4core.ready(function() {
            ...
            var chart = am4core.create("chartdiv_i", am4charts.PieChart3D);
            chart.hiddenState.properties.opacity = 0; // this creates initial fade-in

            $('#post_name_i').html('<?php echo $position_name_i; ?>'); 
            chart.data = <?php echo $json_candidate_i; ?>
    ...
    function position_j(){                                  
        ...
        am4core.ready(function() {
            ...
            var chart = am4core.create("chartdiv_j", am4charts.PieChart3D);
            chart.hiddenState.properties.opacity = 0; // this creates initial fade-in

            $('#post_name_j').html('<?php echo $position_name_j; ?>'); 
            chart.data = <?php echo $json_candidate_j; ?>

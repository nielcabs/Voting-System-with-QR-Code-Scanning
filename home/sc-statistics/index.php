                ...
                <div class="form-floating mb-3 col-lg-12">
                    <select id="election_id" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                            ...
                            <?php
                                    ...
                                    $get = "SELECT a.election_id, a.election_name, b.description, a.date_started, 
                                                   b.election_type, a.department, a.status
                                            FROM tbl_election a
                                            LEFT JOIN tbl_election_type b
                                            ON a.election_name = b.election_type
                                            $query AND a.status IN ('In-Progress','Completed','N')";
                                ...
                                ?>
                                <option value="<?php echo $row['election_id'].'|'. $row['election_type'].'|'.$cnt_candidate; ?>" <?php echo $xslctd; ?>> <?php echo $election_title; ?></option> 
                            <?php  } ?>   
                    </select>
                       ...
                       <!-- Position B -->
                        ...
                        <div class="col-sm-6 mb-2">   
                            <div class="card border-0 shadow">
                                ...
                                <div class="card-body">
                                    <h5 class="fw-bold"><span id="post_name_i"></span></h5>
                                    <div id="chartdiv_i"></div>
                                </div>
                            </div>   
                        </div>
                        <!-- Position J -->
                        <div class="col-sm-6 mb-2">   
                            <div class="card border-0 shadow">
                                ...
                                <div class="card-body">
                                    <h5 class="fw-bold"><span id="post_name_j"></span></h5>
                                    <div id="chartdiv_j"></div>
                                </div>
                            </div>   
                        </div>
                    ...
                    <div class="col-lg-12" id="cnt_candidates">   
                        <div class="card border-0 shadow">

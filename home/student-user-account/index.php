    ...
    <div id="layoutSidenav_content">
        <main> 
            <div class="container">  
                ...
                <div class="my-5">
                    <button id="btnAddUser" type="button" class="btn btn-orange" data-bs-toggle="modal" data-bs-target="#viewUserModal">
            ...
            data: { "rec_id"            : rec_id,
                ...
                success: function(response) {
                    ...
                    if ($.trim(myresponse[0]) == 'Relogin') { 
                        ...
                        Swal.fire('Student Number '+ $.trim(myresponse[0]) +' already exist.','', 'error') 
                        $('#btnSave').prop("disabled", false);

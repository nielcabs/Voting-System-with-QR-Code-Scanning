...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-hover table-light tableDark table-sm" id="dttables_user">
        <thead class="nowrap">
            ...
            <th class="text-center" width="15%">Faculty ID No.</th>
            <th class="text-center" width="29%"> Name</th>
        ...
        <tbody class="">
            ...
            $sql_get = "SELECT a.rec_id, a.username_id, a.first_name, a.middle_name, a.last_name, a.email, a.dept_id, a.year,
                        ...
                        WHERE a.access_rights='faculty_voter'
            ...
            while($row 	= mysqli_fetch_assoc($result)){
                ...
                $data_val               = $rec_id."|".$username_id."|".$user_password."|".$first_name."|".$middle_name."|".$last_name."|".$email."|".$deptid;

                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-light tableDark table-sm" id="dttables">
                                <thead class="table-secondary text-center th-fs">
                                    <tr class="">
                                        <th class="text-center align-middle" width="15%">Faculty ID No.</th>
                                        <th class="text-center align-middle" width="15%">First Name</th>
                                        <th class="text-center align-middle" width="15%">Middle Name</th>
                                        <th class="text-center align-middle" width="15%">Last Name</th>
                                        <th class="text-center align-middle" width="15%">Email</th>
                                        <th class="text-center align-middle" width="13%">Department</th>
                                    </tr>
                                <thead>
                            ...
                            <a id="" href="../faculty-user-account" type="button" class="btn btn-secondary px-4 pull-right">Go Back to Faculty Accounts</a>
                        </div>

        ...
        if($_FILES["upload_img"]["name"] ?? null !=""){
            ...
            if($row_cnt1 ==0){
                ...
                if ($row_cnt > 0) {
                    ...
                    $save_rec = "INSERT INTO tbl_candidates (student_id, first_name, middle_name, last_name, position, party_name,
                                                                    platform, election_id, dept_id, added_by, date_added, profile_pic, election_status)					 
                                VALUES ('$student_id', '$first_name', '$middle_name', '$last_name', '$position', '$party_name',
                                        '$platform', '$election_id', '$department', '$user_fname', NOW(), '$upload_img', 'N')";
                ...
                if ($row_cnt > 0) {
                    ...
                    $sql_update  = "UPDATE tbl_candidates
                                    SET /*student_id = '$student_id', first_name = '$first_name', middle_name = '$middle_name', last_name = '$last_name',*/
                                        position = '$position', platform = '$platform', election_id = '$election_id', dept_id = '$department', party_name = '$party_name',

    ...
    <table class="table table-bordered table-hover table-light tableDark table-sm" id="dttables_user">
        <thead class="nowrap">
            <tr class="table-secondary text-center th-fs"> 
                ...
                <th class="text-center" width="10%">Faculty ID No.</th>
        ...
        <tbody class="">
            ...
            $sql_get = "SELECT a.rec_id, a.student_id, a.first_name, a.middle_name, a.last_name, a.dept_id, a.year,
                        ...
                        LEFT JOIN (SELECT position_id, position_name FROM tbl_position WHERE election_type ='FCE') d
                        ON a.position = d.position_id
                        LEFT JOIN tbl_department e
                        ON a.dept_id = e.dept_id
                        WHERE c.election_type ='FCE'
                        ORDER BY a.rec_id DESC, d.position_id";

...
$ballot_receipt_code   = $_POST['ballot_receipt_code'];

//for testing
//$electionID            = "LDSC-CIT-10242022-40594";
// $studentID             = "10999";
...
$sql1    ="SELECT a.election_id, a.election_name, a.status, a.date_started, a.date_end, b.description
            ...
            WHERE a.election_name='LDSC' AND a.election_id='$electionID'";
...
//-- Subject --//
$phpmailer->Subject = 'DVHSU: '.$election_year.' '.$dept_name.' Student Council Election '.'E-Voting Verification Receipt';
...
<body>
    ...
    <p class="p_text mb-n4">Election: <?php echo $election_year.' '.$dept_name.' Student Council Election'; ?></p>
    ...
    <!-- <table class="border_c" width="560" border="0" cellpadding="2" cellspacing="0">
        ...
        <tbody>
            ...
            <?php
                ...
                //                       WHERE c.election_id = '$electionID' and d.election_type='LDSC') b

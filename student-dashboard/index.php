<?php
    ...
    $status_ldsc         = $row2['status'] ?? '';

    //Check if already voted
    $sql5    ="SELECT a.election_id, a.student_id_voter, a.status_vote
                FROM tbl_voter_status a
                WHERE a.election_id = '$id_election1' and student_id_voter = '$username_id'";
    $res5 = mysqli_query($db,$sql5);
    $row5 = mysqli_fetch_assoc($res5);

    $my_status_vote_usc        = $row5['status_vote'] ?? '';

    $sql6    ="SELECT a.election_id, a.student_id_voter, a.status_vote
                FROM tbl_voter_status a
                WHERE a.election_id = '$id_election2' and student_id_voter = '$username_id'";
    $res6 = mysqli_query($db,$sql6);
    $row6 = mysqli_fetch_assoc($res6);

    $my_status_vote_ldsc        = $row6['status_vote'] ?? '';
...
<?php 
        ...
        // Party
        // $sql2	="SELECT party_name
        //         FROM tbl_party
        //         LEFT JOIN tbl_candidates
        //         WHERE username_id ='$username_id'";	
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main class="mt-5"> 
                <div class="container">  
                    <h4 class="mb-4 mt-4 dashboard-text">
                                ...
                                <div class="row g-2">
                                        ...
                                        <div class="card position-relative p-2 gradient-bg border-0 section-banner" style="z-index: 2;">
                                            <div class="card-body d-flex justify-content-between text-white">
                                                <div>
                                                    ...
                                                    <p class="subtitle">Welcome to e-voting system. In an University Student Election all students at DHVSU are required to vote Localized Student Election students at specific department can only vote. Check how voting is carried out in your organization.
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0 bg-light-orange">
                                            ...
                                            <div class="mx-3">
                                                <h5 class="candidates-header fw-bold bg-red text-white text-center p-2 mb-0">University Student Council</h5>
                                                <?php if($status_usc =='In-Progress'){ ?>
                                                    ...
                                                    <div class="carousel-inner rounded-3">
                                                        <?php
                                                                ...
                                                                while($row    = mysqli_fetch_assoc($result)) {
                                                                    ...
                                                                    $first_name_z         = $row['first_name'];
                                                                    $middle_name_z        = $row['middle_name'];
                                                                    $last_name_z          = $row['last_name'];
                                                                    ...
                                                                    $profile_pic_z        = $row['profile_pic'];
                                                                    $candidate_name       = $last_name_z.', '.$first_name_z.'. '.$middle_name_z;
                                                        ?>
                                                        <div class="carousel-item <?php if($seq_no =="1"){ echo"active";}else{echo"";} ?> py-3 card shadow border-0 p-3 text-center candidate">

                                                            <?php if($profile_pic_z !=''){?>
                                                                <img class="avatar-image rounded-circle" src="<?php echo "../".$profile_pic_z; ?>" alt="Image">
                                                            <?php } else {?>
                                            ...
                                            <div class="mx-3">
                                                ...
                                                <?php if($status_ldsc =='In-Progress'){ ?>
                                                <div id="carouselCandidatesSC" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                                    ...
                                                    ?>
                                                        <div class="carousel-item <?php if($seq_no =="1"){ echo"active";}else{echo"";} ?> py-3 card shadow border-0 p-3 text-center candidate">
                                                            <?php if($profile_pic_v !=''){?>
                                                                <img class="avatar-image rounded-circle" src="<?php echo "../".$profile_pic_v; ?>" alt="Image">
                                                            <?php } else {?>
                                                                <img class="avatar-image rounded-circle" src="../img/speech.png" alt="Image">
                                                            <?php }?>
                                                            <div class="details">
                                                    ...
                                                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselCandidatesSC" data-bs-slide="prev">
                                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                        <span class="visually-hidden">Previous</span>
                                                    </button>
                                                    <button class="carousel-control-next" type="button" data-bs-target="#carouselCandidatesSC" data-bs-slide="next">
                                                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                        <span class="visually-hidden">Next</span>
                                                    </button>
                                                </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="d-flex align-items-center flex-wrap p-3 bg-light-orange">
                                            <div class="me-3">
                                                <img src="../img/candidate.png" alt="" class="img-fluid mr-2 my-2" style="height: 110px;">
                                            </div>
                                            <div>
                                                <h6>University Student Council</h6>
                                                <p class="small">A group of volunteer students to assists students in school affairs and activities, give opportunities for student experience in leadership and encourage student relations.

                                                </p>
                                                <a href="<?php echo $url; ?>student-dashboard/candidates/usc/" id="viewCandidates" class="btn btn-outline-yellow btn-sm">view all candidates</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="d-flex align-items-center flex-wrap p-3 bg-light-orange">
                                            ...
                                            <div>
                                                <h6>Localized Student Council</h6>
                                                <p class="small">A group of volunteer students to provide a means for an organization of students within a school that represents the interests of the students per department.</p>
                                                <a href="<?php echo $url; ?>student-dashboard/candidates/lsc/" id="viewCandidates" class="btn btn-outline-yellow btn-sm">view all candidates</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="prof_email text-muted"><?php echo $email; ?></p>
                                        </div>
                                        <div class="my-5">
                                            <h5 class="title mb-3">Student Information</h5>
                                            <ul class="list-unstyled">
                                                <li>
                                                    <h6 class="subtitle mb-0">Last Name</h6>
                                                    <p class="subtitle"><?php echo $last_name; ?></p>
                                                </li>
                                                <li>
                                                    <h6 class="subtitle mb-0">First Name</h6>
                                                    <p class="subtitle"><?php echo $first_name; ?></p>
                                                </li>
                                                <li>
                                                    <h6 class="subtitle mb-0">Middle Name</h6>
                                                    <p class="subtitle"><?php echo $middle_name; ?></p>
                                                </li>
                                                <li>
                                                    <h6 class="subtitle mb-0">Department</h6>
                                        ...
                                        <div class="position-relative btn-holder mt-auto">
                                            <div class="arrow"></div>
                                            <?php if($my_status_vote_usc == 'Y') {?>
                                                <a class="btn btn-orange btn-custom disabled btn-md w-100 mt-3" aria-disabled="true" href="" role="button">Voted for University Student Council</a>
                                            <?php } else if($my_status_vote_usc == 'A') {?>
                                                <a class="btn btn-orange btn-custom disabled btn-md w-100 mt-3" href="usc-vote/" role="button">Abstained from Voting</a>
                                            <?php } else { ?>
                                                <a class="btn btn-orange btn-custom btn-md w-100 mt-3" aria-disabled="true" href="usc-vote/" role="button">Vote for University Student Council</a>
                                            <?php } ?>
                                            <?php if($my_status_vote_ldsc == 'Y') {?>
                                                <a class="btn btn-orange btn-custom btn-md w-100 mt-3 disabled" aria-disabled="true" href="lsc-vote/" role="button">Voted for Localized Student Council</a>
                                            <?php } else if($my_status_vote_ldsc == 'A') {?>
                                                <a class="btn btn-orange btn-custom disabled btn-md w-100 mt-3" aria-disabled="true" href="lsc-vote/" role="button">Abstained from Voting</a>
                                            <?php } else { ?>
                                                <a class="btn btn-orange btn-custom btn-md w-100 mt-3" href="lsc-vote/" role="button">Vote for Localized Student Council</a>
                                            <?php } ?>
        ...
        <div class="modal fade" id="guideModal" tabindex="-1" aria-labelledby="guideModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <?php if($my_status_vote_usc == 'Y') {?>
                    <a class="btn btn-orange btn-custom disabled btn-md mt-3" aria-disabled="true" href="" role="button">Voted for USC</a>
                <?php } else if($my_status_vote_usc == 'A') {?>
                    <a class="btn btn-orange btn-custom disabled btn-md mt-3" href="usc-vote/" role="button">Abstained</a>
                <?php } else { ?>
                    <a class="btn btn-orange btn-custom btn-md mt-3" aria-disabled="true" href="usc-vote/" role="button">Vote for USC</a>
                <?php } ?>
                <?php if($my_status_vote_ldsc == 'Y') {?>
                    <a class="btn btn-orange btn-custom btn-md mt-3 disabled" aria-disabled="true" href="lsc-vote/" role="button">Voted for LSC</a>
                <?php } else if($my_status_vote_ldsc == 'A') {?>
                    <a class="btn btn-orange btn-custom disabled btn-md mt-3" aria-disabled="true" href="lsc-vote/" role="button">Abstained</a>
                <?php } else { ?>
                    <a class="btn btn-orange btn-custom btn-md mt-3" href="lsc-vote/" role="button">Vote for LSC</a>
                <?php } ?>
                </div>
                </div>
            </div>

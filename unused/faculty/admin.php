  ...
  <main class="dashboard">
    ...
    <div class="tab-content p-4 h-100 w-100" id="pills-tabContentFaculty">
      ...
      <div class="tab-pane fade" id="pills-voter-accounts" role="tabpanel" aria-labelledby="pills-voter-accounts-tab">
        <?php require('../components/admin-faculty-voter-accounts.inc.php'); ?>
      </div>
      <div class="tab-pane fade" id="pills-register-candidates" role="tabpanel" aria-labelledby="pills-register-candidates-tab">
        <?php require('../components/admin-faculty-create-election.inc.php'); ?>
      </div>
      <div class="tab-pane fade" id="pills-register-candidates" role="tabpanel" aria-labelledby="pills-register-candidates-tab">
        <?php require('../components/admin-faculty-register-candidates.inc.php'); ?>
      </div>
    </div>
    <?php require('../components/admin-faculty-add-candidates-account.inc.php'); ?>
    <?php require('../components/admin-faculty-edit-voters-account.inc.php'); ?>

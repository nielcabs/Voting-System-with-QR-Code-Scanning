    ...
    if (!isset($_SESSION['E_Voting_System'])) {
        ...
        if($rec_id == '' && $action =='Add'){
            ...
            if ($row_cnt > 0) {
                ...
                $save_rec = "INSERT INTO dhvsuevo_voting.tbl_election (election_id, election_name, department, status, date_started, date_created, added_by)					 
            ...
            if ($row_cnt > 0) {
                ...
                $sql_update  = "UPDATE dhvsuevo_voting.tbl_election
